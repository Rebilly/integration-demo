...
<div class="ui stackable grid centered container user">
    <div class="eleven wide column">
        <h2 class="ui header title color brand">Edit Subscription</h2>
        <div class="ui segment management">
            ...
            <form class="ui form" method="post">
                <div class="field">
                    ...
                    <input type="radio" value="<?= $plan->getId() ?>" id="plan-<?= $plan->getId() ?>" name="Subscription[planId]"<?= $subscription->getPlanId() === $plan->getId() ? ' checked="checked"' : '' ?>>
                ...
                <div class="three wide field">
                    ...
                    <input type="text" name="Subscription[quantity]" value="<?= $subscription->getQuantity() ?>">
                </div>
                <div class="ui hidden divider"></div>
